# encoding: utf-8
#
# Page extensions for Jekyll
# https://github.com/paceline/jekyll-page-extensions
#
...
module Jekyll
  ...
  # 
  #
  class PritablePageGenerator < Generator
    safe true
    priority :high
  ...
  #
  #
  class PageBreadcrumbsTag < Liquid::Tag
...
Liquid::Template.register_tag('toc', Jekyll::PageTocTag)
Liquid::Template.register_tag('breadcrumbs', Jekyll::PageBreadcrumbsTag)
Liquid::Template.register_tag('link_to', Jekyll::PageLinkTag)
